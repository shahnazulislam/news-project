  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-offset-3 col-md-6">
        ...
        $sql = "SELECT user.user_id, user.username, post.post_id, post.post_date, post.category, category.category_id, post.title, post.post_img, category.category_name, post.description FROM post
